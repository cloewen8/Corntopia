...
public class BarnGenerator {
	...
	public static void addPieces(StructureManager manager, BlockPos pos, BlockRotation rotation, List<StructurePiece> pieces, Random random) {
		...
		pieces.add(new Piece(manager, "base", pos, rotation, false, Blocks.OAK_PLANKS.getDefaultState(), barnType));
		if (toggles[0])
		...
		if (toggles[4]) {
			pieces.add(new Piece(manager, "platform", pos.add(new BlockPos(6, 0, 2).rotate(rotation)), rotation, false, Blocks.OAK_PLANKS.getDefaultState(), barnType));
			if (toggles[5])
		...
		if (toggles[7]) {
			pieces.add(new Piece(manager, "platform", pos.add(new BlockPos(5, 0, 2).rotate(rotation)), rotation, true, Blocks.OAK_PLANKS.getDefaultState(), barnType));
			if (toggles[8])
